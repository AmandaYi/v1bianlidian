...
export class Md5 {
  ...
  private static instance: Md5 = new Md5();
  ...
  chrsz: any = 8; /* bits per input character. 8 - ASCII; 16 - Unicode  */
  ...
  core_hmac_md5(key, data) {
    ...
    let hash = this.core_md5(ipad.concat(this.str2binl(data)), 512 + data.length * this.chrsz);
